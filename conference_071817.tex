...
\fi
We found that there is a big difference in behavior between normal users and abnormal users at different times in a day. These abnormal users have more frequent operations in midnight comparing with normal users. So, we divide the 24 hours of a day into 4 time segments: (0:00-06:00),(0:60-12:00),(12:00-18:00),(18:00-23:00). The maximum or mode counts of user behaviors with regard to the five domains are calculated for the 4 segments respectively. Table 1 is an illustration of the feature set.
